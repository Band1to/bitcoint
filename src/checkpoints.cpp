...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 0,   uint256("0x00000fe804f4811169424161e0e896cbfc20ca5a5c04f04f997c7e7776cf5613") )
    ;
    ...
    bool ValidateSyncCheckpoint(uint256 hashCheckpoint)
    {
        ...
        if (pindexCheckpointRecv->nHeight <= pindexSyncCheckpoint->nHeight)
        {
            ...
            LogPrintf("ValidateSyncCheckpoint : pre-false\n");
...
const std::string CSyncCheckpoint::strMasterPubKey = "028602484c25a07f9173a664cdc979df6e07d78b5a75fa624dbd1d7898a6410dbb";
...
{
    if (!CheckSignature()) {
        LogPrintf("ProcessSyncCheckpoint: checksignature \n");
        return false;
    }
    ...
    if (!Checkpoints::ValidateSyncCheckpoint(hashCheckpoint)) {
        LogPrintf("ProcessSyncCheckpoint: validatesynccheckpoint \n");
        return false;
    }
